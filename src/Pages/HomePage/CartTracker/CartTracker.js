...
const CartTracker = ({ cart, handleShow }) => {
  let totalCost = 0.0;
  ...
  return (
    <section id={styles.cart__tracker} onClick={handleShow}>
      <svg stroke='#059669' fill='currentColor' strokeWidth='0' viewBox='0 0 512 512' height='30px' width='30px' xmlns='http://www.w3.org/2000/svg'>
        <path
          fill='none'
          strokeLinecap='round'
